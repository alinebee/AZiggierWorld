...
test "parseNextInstruction returns expected instruction type when given valid bytecode" {
    try expectWrappedType(.ActivateThread, try expectParse(&ActivateThread.BytecodeExamples.valid));
    try expectWrappedType(.Call, try expectParse(&Call.BytecodeExamples.valid));
    try expectWrappedType(.ControlMusic, try expectParse(&ControlMusic.BytecodeExamples.valid));
    try expectWrappedType(.ControlResources, try expectParse(&ControlResources.BytecodeExamples.valid));
    try expectWrappedType(.ControlSound, try expectParse(&ControlSound.BytecodeExamples.valid));
    try expectWrappedType(.ControlThreads, try expectParse(&ControlThreads.BytecodeExamples.valid));
    try expectWrappedType(.DrawBackgroundPolygon, try expectParse(&DrawBackgroundPolygon.BytecodeExamples.valid));
    try expectWrappedType(.DrawSpritePolygon, try expectParse(&DrawSpritePolygon.BytecodeExamples.valid));
    try expectWrappedType(.DrawString, try expectParse(&DrawString.BytecodeExamples.valid));
    try expectWrappedType(.FillVideoBuffer, try expectParse(&FillVideoBuffer.BytecodeExamples.valid));
    try expectWrappedType(.Jump, try expectParse(&Jump.BytecodeExamples.valid));
    try expectWrappedType(.JumpConditional, try expectParse(&JumpConditional.BytecodeExamples.valid));
    try expectWrappedType(.JumpIfNotZero, try expectParse(&JumpIfNotZero.BytecodeExamples.valid));
    try expectWrappedType(.Kill, try expectParse(&Kill.BytecodeExamples.valid));
    try expectWrappedType(.RegisterAdd, try expectParse(&RegisterAdd.BytecodeExamples.valid));
    try expectWrappedType(.RegisterAddConstant, try expectParse(&RegisterAddConstant.BytecodeExamples.valid));
    try expectWrappedType(.RegisterAnd, try expectParse(&RegisterAnd.BytecodeExamples.valid));
    try expectWrappedType(.RegisterCopy, try expectParse(&RegisterCopy.BytecodeExamples.valid));
    try expectWrappedType(.RegisterOr, try expectParse(&RegisterOr.BytecodeExamples.valid));
    try expectWrappedType(.RegisterSet, try expectParse(&RegisterSet.BytecodeExamples.valid));
    try expectWrappedType(.RegisterShiftLeft, try expectParse(&RegisterShiftLeft.BytecodeExamples.valid));
    try expectWrappedType(.RegisterSubtract, try expectParse(&RegisterSubtract.BytecodeExamples.valid));
    try expectWrappedType(.RenderVideoBuffer, try expectParse(&RenderVideoBuffer.BytecodeExamples.valid));
    try expectWrappedType(.Return, try expectParse(&Return.BytecodeExamples.valid));
    try expectWrappedType(.SelectPalette, try expectParse(&SelectPalette.BytecodeExamples.valid));
    try expectWrappedType(.SelectVideoBuffer, try expectParse(&SelectVideoBuffer.BytecodeExamples.valid));
    try expectWrappedType(.Yield, try expectParse(&Yield.BytecodeExamples.valid));
}
