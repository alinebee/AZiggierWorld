...
//! It turns out that this is the ByteKiller 1.3 compression algorithm, which was also used
//! in Delphine games:
//! https://wiki.scummvm.org/index.php/Cine/Specifications#Compression_format_.28Bytekiller_1.3.29
//!
