...
pub const Audio = struct {
    ...
    pub fn playSound(_: *Self, sound_data: []const u8, channel_id: vm.ChannelID, volume: audio.Volume, frequency: audio.Frequency) !void {
        log.debug("playSound: play {*} on channel {} at volume {}, frequency {}", .{
            sound_data,
            channel_id,
            volume,
            frequency,
